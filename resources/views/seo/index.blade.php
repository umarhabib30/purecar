...
?>
         ...
         <div class="d-flex justify-content-start align-items-center">
            <h1 style="font-size: 18px; font-weight: bold;">{{ $h1_heading }}</h1>
         </div>
        ...
        <section class="text-center mobilecontainer" style="margin-top:10px;">
            <h1 class="business-name" style="font-size: 34px;" id="businessName">More Cars for Sale</h1>

        <script>
        if (window.innerWidth <= 768) { 
            document.getElementById('businessName').style.fontSize = '24px';
        }
        </script>
