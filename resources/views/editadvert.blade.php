...
<section>
    ...
    <div class="outer-container " style="background: #f5f6fa; padding-bottom: 15px;">
        ...
        <div id="inner-container">
            <form action="{{ route('update_advert', $advert->advert_id) }}" method="POST" enctype="multipart/form-data"
...
document.getElementById('images').addEventListener('change', function() {
    // The rest of the progress bar logic remains the same
    let progressContainer = document.getElementById('progressContainer');
    let progressBar = document.getElementById('progressBar');
    let progressText = document.getElementById('progressText');
...
<script>
// Store files globally to maintain reference
let uploadedFiles = [];
...
$(document).ready(function() {
    ...
    $("#mileage-input").blur(function() {
        let newMileage = $(this).val().replace(/\D/g, ''); // Remove non-numeric characters
        if (newMileage !== "") {
