        ...
        <div class="blogs-content">
            <div class="top-bar">
                ...
                <div class="add-blog">
                    ...
                    <button class="add-blog-btn" onclick="window.location.href = '{{ url('/event/create') }}'">+ Add Event</button>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="featured-image-cell">
                                <img src="{{ asset(''. $event->featured_image) }}" alt="Featured Image"
                            ...
                            <td class="date-posted">
                                <img src="assets/adminPanelAssets/bs/calendar-icon.png" alt="Calendar Icon"
                                    class="calendar-icon">
                                <p class="date">{{ $event->created_at->format('M d, Y') }}</p>
                            </td>
                            ...
                            <td class="action-1">
                                <div class="action-1-div">
                                    ...
                                    <a href="{{ route('event.delete', ['event' => $event->id]) }}"
