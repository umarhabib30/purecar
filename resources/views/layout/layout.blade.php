...
{{--    <link href="{{ asset('bootstrap/bootstrap.min.css') }}" rel="stylesheet" type="text/css" id="bootstrap">--}}
  ...
  <link rel="stylesheet" href="https://purecar.co.uk/css/grid_car_cards_layout.css">  
    ...
    <style>
        *{
        ...
        @media only screen and (max-width: 767px) {
            ...
            .filter-box .filter-inner .filter-item .dropdown-toggle {
...
<nav class="navbar navbar-expand-lg" style="z-index:999;">
    <div class="container-fluid d-flex justify-content-between align-items-center" style="z-index: 1000;">
      ...
      <button
                class="btn d-block d-md-none me-2"  type="button"
                style="background-color: #FF1717; color: white; font-weight: 500;"
                onclick="redirectToPayment()">
                SELL CAR
            </button>
        ...
        <div class="collapse navbar-collapse d-lg-flex gap-lg-2 mobile-menu" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 d-lg-flex gap-lg-2 align-items-lg-center justify-content-lg-center w-100">
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/')}}">
                        <i class="fas fa-home d-lg-none me-2"></i>Home
            ...
            @if (!Auth::check())
            <a class="sell-car-btn btn bg-light d-none d-lg-flex" href="{{route('login')}}">
                Login
            </a>
            @endif
            @if (Auth::check())
                <a href="{{route('dashboard')}}" class="sell-car-btn btn bg-light d-none d-lg-flex">
                    Dashboard
                </a>
            @endif

                <a href="javascript:void(0);" id="submitListingBtn" class="sell-car-btn btn bg-light d-none d-lg-flex" type="submit" onclick="redirectToPage()">
                    <span id="submitListingBtnText">Sell Your Car</span>
                    <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="33" height="32" rx="16" fill="currentColor"/>
                        <path d="M24.6024 15.9989H7.66129" stroke="white" stroke-width="2.09091" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M17.9976 8.92969L25.3633 16.0008L17.9976 23.0718" stroke="white" stroke-width="2.09091" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
              @if (Auth::check())
                <a href="javascript:void(0);" id="submitListingBtnMobile" style="width: 100%; margin-top:20px;" class="btn bg-dark text-white pt-2 pb-2 d-lg-none" type="submit" onclick="redirectToPage()">
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
      ...
      @yield('body')
        <!-------------Footer---------------->
        <footer class="footer-section-container" style="margin-top: 50px; border-radius: 60px 60px 0 0;">
...
<script>
 ...
 <script>
    ...
    @guest
        ...
        window.location.href = "{{ route('pricing.package') }}";
    @endguest
}
